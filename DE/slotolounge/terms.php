...
<section id="terms" class="w-full min-h-screen bg-[#F9F4E6] py-16 px-4">
  <div class="max-w-4xl mx-auto text-[#7D6A55] backdrop-blur-xl rounded-3xl shadow-2xl p-8 md:p-14 border border-[#DDD2B4]">
    ...
    <section class="prose prose-invert prose-lg max-w-none font-montserrat text-[#5A4A3F] space-y-4">
      <h2 class="text-2xl font-extrabold text-[#C9A66B]">Allgemeine Geschäftsbedingungen für das Portal
        [CURRENT_DOMAIN_NO_TLD], betrieben von der WHOW Games GmbH (im Folgenden "WHOW")</h2>
      <h3 class="text-xl font-bold text-[#C9A66B] mt-8">Inhaltsverzeichnis</h3>
      ...
      <h3 class="text-xl font-bold text-[#C9A66B]">1. Geltungsbereich</h3>
      ...
      <p>1.1.1 WHOW stellt seine Dienste ausschließlich nicht-kommerziellen Nutzern im Sinne des § 13 BGB zur Verfügung.
        Jegliche Nutzung der WHOW-Spiele und -Dienste zu gewerblichen oder sonstigen kommerziellen Zwecken ist
        ausdrücklich untersagt.</p>

      <p>1.1.2 Zur vollständigen Nutzung der von WHOW angebotenen Spiele und Dienste sind ausschließlich Personen
        berechtigt, die das 18. Lebensjahr vollendet haben oder in deren Wohnsitzland das gesetzlich festgelegte
        Mindestalter für Glücks- oder Spieltätigkeiten erreicht haben.</p>

      <p>1.1.3 Durch die Registrierung und/oder Installation der Spiele oder Dienste versichert und bestätigt der Nutzer
        ausdrücklich, dass er das gesetzlich erforderliche Mindestalter erreicht hat.</p>

      <p>1.1.4 Nutzern mit Wohnsitz in Kuba, Iran, Nordkorea, Sudan und Syrien ist die Nutzung der Spiele ausdrücklich
        untersagt.</p>

      <h4>1.2 Vertragsgegenstand, Nutzung und Änderungen der Spiele und Dienste</h4>

      <p>1.2.1 WHOW gewährt seinen Nutzern Zugang zum Portal sowie die Möglichkeit, dort angebotene Spiele und Dienste
        nach Maßgabe der vorhandenen technischen und wirtschaftlichen Möglichkeiten zu nutzen.</p>

      <p>1.2.2 Die Teilnahme an den Spielen dient ausschließlich der Unterhaltung.</p>

      <p>1.2.3 Im Rahmen seiner Dienste speichert WHOW bestimmte Informationen auf dem Portal und bietet den Nutzern die
        Möglichkeit, Inhalte ins Internet hochzuladen und persönliche Profile zu erstellen, die sowohl anderen Nutzern
        der WHOW-Dienste als auch Dritten einsehbar sind. Darüber hinaus kann der Nutzer über das Portal mit Dritten
        kommunizieren, Fotos, Videos, Spiele, Musik und andere Medien hochladen und austauschen, Blogs und Kommentare
        veröffentlichen sowie Spiele, andere Nutzer, Dritte oder Transaktionen bewerten.</p>

      <p>1.2.4 Die hier genannten Spiele und Dienste sind solche, die von WHOW bereitgestellt werden, um dem Nutzer
        während der Vertragslaufzeit die erforderliche Software zur Nutzung des Portals zur Verfügung zu stellen. Die
        Online-Nutzung der WHOW-Spiele und -Dienste erfolgt durch Bereitstellung der erforderlichen Anwendungen unter
        den jeweiligen URLs durch WHOW.</p>

      <p>1.2.5 Die Nutzung der WHOW-Spiele und -Dienste ist ausdrücklich auf Personen beschränkt, die zuvor ein
        Kundenkonto („Account“) bei der Registrierung erstellt haben. Die Registrierung erfolgt online durch
        vollständiges Ausfüllen des Registrierungsformulars auf dem Portal oder über eine andere Webseite mit
        entsprechender Registrierungsfunktion und/oder über die Login-Funktion eines sozialen Netzwerks (z. B. Facebook
        Connect). WHOW behält sich das Recht vor, die Aktivierung eines Kontos von der Bestätigung eines
        Aktivierungslinks abhängig zu machen, der an die vom Nutzer angegebene E-Mail-Adresse gesendet wird. Ein Account
        kann sowohl auf dem Portal als auch unter der URL der jeweiligen Spiele angelegt werden. Ein auf dem Portal
        erstellter Account gewährt dem Nutzer Zugang zu allen Diensten im Rahmen der Bedingungen gemäß Abschnitt 1.1.
      </p>

      <p>1.2.6 Die Registrierung, also die Beantragung eines Accounts, erfolgt elektronisch durch Ausfüllen eines
        Formulars und Angabe der dort geforderten Daten. Die Nutzung der WHOW-Spiele und/oder -Dienste ist ab dem
        Zeitpunkt möglich, zu dem das Konto für den Nutzer von WHOW angelegt wurde.</p>

      <p>1.2.7 Pro Nutzer ist nur ein Account auf dem Portal zulässig. WHOW behält sich das Recht vor, weitere Accounts
        des Nutzers als unzulässig zu sperren.</p>

      <p>WHOW behält sich zudem das Recht vor, Nutzer teilweise oder vollständig vom Dienst auszuschließen, die
        Zahlungen stornieren oder fehlerhafte Zahlungsdaten angeben, vorsätzlich falsche Angaben bei der Registrierung
        machen, sich gegenüber anderen Nutzern, WHOW-Mitarbeitern oder WHOW selbst beleidigend, diffamierend,
        rassistisch oder anderweitig diskriminierend äußern – sei es im Chat, per E-Mail, in sozialen Medien oder auf
        sonstigen Wegen. Dies gilt ebenso für Verstöße gegen die AGB, Spielregeln oder Teilnahmebedingungen. Alle
        etwaigen Ansprüche des Nutzers gegenüber WHOW bezüglich der Spiele, der Teilnahme, virtueller Gegenstände,
        Gewinne, Konten, Einzahlungen, erfolgreich abgewickelter Zahlungen sowie sonstiger daraus resultierender
        Ansprüche verfallen in den genannten Fällen und sind rechtlich unbeachtlich.</p>

      <p>1.2.8 Nach Erstellung eines Accounts kann der Nutzer am jeweiligen Spiel und/oder Dienst teilnehmen, indem er
        das Portal oder die entsprechende URL aufruft und sich einloggt.</p>

      <p>1.2.9 Die Nutzung von Programmen, die eine übermäßige Serverbelastung verursachen, ist streng untersagt. Ebenso
        ist der Einsatz von Software, die Spiele oder Spielkomponenten systematisch oder automatisch steuert (wie Bots,
        Makros etc.), oder das Reproduzieren oder Auswerten von Spielen, Spielbestandteilen oder auf dem Portal
        bereitgestellten Inhalten verboten.</p>

      <p>1.2.10 Die Ausnutzung von Programmfehlern („Bugs“) oder Fehlern zum eigenen Vorteil ist streng untersagt.
        Festgestellte Fehler sind unverzüglich dem Kundensupport zu melden. Nachgewiesene, durch Bugs oder technische
        Fehler erzielte Vorteile sind für den Nutzer ungültig. Die Nutzung der Spiele und Dienste über
        Anonymisierungstechniken (wie Proxys) oder andere Verfahren zur Verschleierung des aktuellen oder gewöhnlichen
        Aufenthaltsorts des Nutzers ist ebenfalls streng untersagt.</p>

      <p>1.2.11 Der Nutzer ist nicht berechtigt, ein Konto zu eröffnen oder beliebige Inhalte auf dem Portal zu
        veröffentlichen.</p>

      <p>1.2.12 Sämtliche jeweils geltenden technischen und sonstigen Spiel- und Teilnahmevoraussetzungen für die
        angebotenen Dienste sind im Portal (z. B. Spielbeschreibungen, Teilnahmebedingungen etc.) und/oder auf den
        Webseiten der jeweiligen Spiele aufgeführt.</p>

      <p>1.2.13 Alle Spiele und Dienste werden regelmäßig aktualisiert, angepasst, erweitert und modifiziert. Die
        Spielberechtigung des Nutzers umfasst daher immer ausschließlich das Recht zur Nutzung der jeweils aktuellsten
        Version der betreffenden Spiele und Dienste.</p>

      <p>1.2.14 Die Nutzung der Spiele in der jeweiligen Basisversion (Free2Play-Version) ist kostenlos. Bestimmte
        Funktionen stehen nur zahlenden Nutzern zur Verfügung (siehe Abschnitt 7). Die Nutzung der Dienste ist
        kostenfrei, sofern in der Beschreibung des jeweiligen Dienstes nichts anderes angegeben ist.</p>

      <p>1.2.15 Der Nutzer hat keinen Anspruch darauf, die zum Zeitpunkt des Vertragsschlusses bestehende Version eines
        Dienstes, insbesondere eines Spiels oder sonstigen Angebots, dauerhaft zu behalten. WHOW behält sich das Recht
        vor, den Dienst insgesamt oder einzelne Spiele oder Dienste jederzeit und ohne Vorankündigung oder Angabe von
        Gründen einzustellen. In einem solchen Fall kann der Nutzer verlangen, dass im Voraus gezahlte Gebühren für
        fortlaufende Leistungen (z. B. virtuelle Gegenstände, Abonnements) erstattet werden, sofern WHOW die
        entsprechende Gegenleistung nicht erbracht hat. Das Recht gilt nicht für Gebühren für Einzelleistungen, die
        bereits vollständig erbracht wurden. Das Recht des Nutzers zur außerordentlichen Kündigung bleibt unberührt.
        Weitere Ansprüche des Nutzers sind ausgeschlossen, sofern in diesen AGB nicht ausdrücklich etwas anderes
        geregelt ist.</p>

      <h3 class="text-xl font-bold text-[#C9A66B]">2. Conclusion of Contract for the Usage of the respective Portal</h3>
      ...
      <div style="border: 1px solid white; padding-left: 10px; font-weight: 700;">
        <h3 class="text-xl font-bold text-[#C9A66B]">3. WITHDRAWAL POLICY</h3>
      ...
      <h3 class="text-xl font-bold text-[#C9A66B]">4. Availability</h3>
      ...
      <h3 class="text-xl font-bold text-[#C9A66B]">5. Access to these Terms &amp; Conditions, Changes and Further
      ...
      <h3 class="text-xl font-bold text-[#C9A66B]">6. Instructions, Rules of the Games, Conditions of Participation</h3>
      ...
      <h3 class="text-xl font-bold text-[#C9A66B]">7. Playing for Free, Fees, Payment Conditions, Late Payment</h3>
      ...
      <h3 class="text-xl font-bold text-[#C9A66B]">8. Term, Cancellation</h3>
      ...
      <h3 class="text-xl font-bold text-[#C9A66B]">9. Responsibilities and Other Obligations of the User; Liability for
      ...
      <h3 class="text-xl font-bold text-[#C9A66B]">10. Claims Based on Defects</h3>
      ...
      <h3 class="text-xl font-bold text-[#C9A66B]">11. Liability and Limitation of Liability</h3>
      ...
      <h3 class="text-xl font-bold text-[#C9A66B]">12. Online Dispute Resolution</h3>
      ...
      <h3 class="text-xl font-bold text-[#C9A66B]">13. Data Protection Regulations</h3>
      ...
      <h3 class="text-xl font-bold text-[#C9A66B]">14. Final Clauses</h3>
      ...
      <div class="mt-8 text-[#7D6A55] rounded-xl border border-[#DDD2B4] p-5 text-base">
