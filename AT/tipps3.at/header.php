...
<header id="header" class="fixed top-0 left-0 w-full z-50 bg-[#343941]/80 backdrop-blur-md">
  <div class="max-w-7xl mx-auto px-4 sm:px-8 h-36 flex items-center justify-between">
    ...
    <a href="/register" class="ml-4 inline-flex items-center px-5 py-2 rounded-full font-semibold text-[#23272F] bg-[#A5FF00] hover:bg-[#8ED600] transition">
      Jetzt registrieren
    </a>
  </div>
</header>
